...
const [page, setPage] = useState(()=>{
  ...
  if(url.searchParams.has('page')){
    return Number(url.searchParams.has('page'))
  }
  return 1
});
...
function setCurrentPage(page: number){
  ...
  function goToNextPage(){
   ...
   setCurrentPage(page+1) //Para o não reinicio de aplicações para URL
  }
    ...
    <div className="flex flex-col gap-4">
      <div className="flex gap-3 items-center">
       <h1 className="text-2xl font-bold">Participantes </h1>
        <div className="px-3 w-72px py-1.5 border border-white/10 rounded-lg text-sm flex items-center gap-3">
